        ...
        <h2>Experiences</h2>
          <div className="experiene-cards">
            <Workcard pic="images/voidtechlogo.jpg" web="https://void-tech-um.github.io/index.html"
              name="VOID Tech" title="Software Developer" team="Developer Team" duration="Janurary 2025 - Present" location="Ann Arbor, MI"/>
            <Workcard pic="images/michiganhackerslogo.jpg" web="https://michhackers.com/"
              name="Michigan Hackers" title="Software Developer" team="Advanced Web Development Team" duration="September 2024 - Present" location="Ann Arbor, MI"/>
