    ...
    <div className="about" id="about">
      <div className="about-container">
        ...
        <div className="about-text">
          ...
          <p>My experience spans from full-stack development, cloud computing, and data science which includes technologies and languages such as C/C++, React.js, Python, Pandas, AWS, and others.</p>
